...
///     IOCFG3         0x33  HW0
///     IOCFG2         0x33  HW0
///     IOCFG1         0x30  HIGHZ (MISO when chip is chip-selected)
///     IOCFG0         0x00  RXFIFO_THR
///     SYNC3          0x54
///     SYNC2          0x3D
///     SYNC1          0x54
///     SYNC0          0x3D
...
pub const CC1200_WMBUS_MODECMTO_FULL_PACKET: Cc1200Config = Cc1200Config {
    first: Reg::IOCFG3,
    values: &[
        ...
        0x54, // SYNC3                 Sync Word Configuration [31:24]
        ...
        0x40, // PKT_CFG0              Packet Configuration Reg. 0
...
/// The following sequence of adjustmensts are performed after the CC1200 chip is selected from the main screen:
/// 1. Select "Expert Mode".
/// 2. Select the "Continuous RX" mode.
/// 3. In the Device Control Panel, under Typical Settings, select "Symbol rate: 100kbps, 2-GFSK, ETSI Standard (868MHz)".
/// 4. Under RF parameters, set:
///     Carrier Frequency: 868.949890MHz (868.950MHz)
///     RX Filter BW: 208.333333kHz (200kHz)
///     Modulation Format: 2-FSK
///     Deviation: 45.013428kHz (45kHz)
/// 5. Set the Syncword Detection threshold value to 31 which is the weakest possible threshold.
/// 6. In the Register View, make the following final adjustments:
///     IOCFG3         0x33  HW0
///     IOCFG2         0x33  HW0
///     IOCFG1         0x30  HIGHZ (MISO when chip is chip-selected)
///     IOCFG0         0x00  RXFIFO_THR
...
pub const CC1200_WMBUS_MODECMTO_FULL_INFINITY: Cc1200Config = Cc1200Config {
    first: Reg::IOCFG3,
    values: &[
        0x33, // IOCFG3                GPIO3 IO Pin Configuration
        0x33, // IOCFG2                GPIO2 IO Pin Configuration
        0x30, // IOCFG1                GPIO1 IO Pin Configuration
        0x00, // IOCFG0                GPIO0 IO Pin Configuration
        0x55, // SYNC3                 Sync Word Configuration [31:24]
        0x55, // SYNC2                 Sync Word Configuration [23:16]
        0x54, // SYNC1                 Sync Word Configuration [15:8]
        0x3D, // SYNC0                 Sync Word Configuration [7:0]
        ...
        0xF6, // AGC_CS_THR            Carrier Sense Threshold Configuration
        0x00, // AGC_GAIN_ADJUST       RSSI Offset Configuration
        0x11, // AGC_CFG3              Automatic Gain Control Configuration Reg. 3
        0x20, // AGC_CFG2              Automatic Gain Control Configuration Reg. 2
        0x12, // AGC_CFG1              Automatic Gain Control Configuration Reg. 1
        0x80, // AGC_CFG0              Automatic Gain Control Configuration Reg. 0
        0x10, // FIFO_CFG              FIFO Configuration
